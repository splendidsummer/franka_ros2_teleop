...
def generate_launch_description():
    ...
    controller_manager = Node(
        ...
        parameters=[
            ...
            os.path.join(get_package_share_directory('franka_gazebo_bringup'), 'config', 'franka_gazebo_controllers.yaml')
        ],
        output='screen',
    )
    ...
    joystick_cartesian_pose_controller = ExecuteProcess(
        cmd=['ros2', 'control', 'load_controller', '--set-state', 'active',
                'joystick_cartesian_pose_controller'],
        output='screen'
    )
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
                ...
                on_exit=[joystick_cartesian_pose_controller],
            )
        ),
        Node(
